...
declare module 'github.com/larksuite/oapi-sdk-go/v3/card'{
	...
	// @ts-ignore
	import type {bool,Struct,error,int,Alias,Nothing,Ref,map} from 'go'
	...
	export interface MessageCardAction extends Struct<MessageCardAction>,MessageCardElement,json.Marshaler,json.Token{
	...
	export interface MessageCardActionConfirm extends json.Token,Struct<MessageCardActionConfirm>{
	...
	export interface MessageCardActionLayout extends Alias<string>{
	...
	export interface MessageCardButtonType extends Alias<string>{
	...
	export interface MessageCardConfig extends json.Token,Struct<MessageCardConfig>{
	...
	export interface MessageCardDiv extends Struct<MessageCardDiv>,json.Token,json.Marshaler,MessageCardElement{
	...
	export interface MessageCardEmbedButton extends Struct<MessageCardEmbedButton>,json.Marshaler,MessageCardActionElement,json.Token,MessageCardExtraElement{
	...
	export interface MessageCardEmbedDatePicker extends Struct<MessageCardEmbedDatePicker>,MessageCardExtraElement,json.Marshaler,MessageCardActionElement,json.Token{
	...
	export interface MessageCardEmbedImage extends Struct<MessageCardEmbedImage>,json.Token,MessageCardExtraElement,MessageCardNoteElement,json.Marshaler{
	...
	export interface MessageCardEmbedOverflow extends Struct<MessageCardEmbedOverflow>,MessageCardActionElement,json.Token,MessageCardExtraElement,json.Marshaler{
	...
	export interface MessageCardEmbedPickerDatetime extends MessageCardExtraElement,Struct<MessageCardEmbedPickerDatetime>,json.Marshaler,MessageCardActionElement,json.Token{
	...
	export interface MessageCardEmbedPickerTime extends Struct<MessageCardEmbedPickerTime>,MessageCardActionElement,json.Token,MessageCardExtraElement,json.Marshaler{
	...
	export interface MessageCardEmbedSelectMenuPerson extends MessageCardActionElement,json.Token,MessageCardExtraElement,Struct<MessageCardEmbedSelectMenuPerson>,json.Marshaler{
	...
	export interface MessageCardEmbedSelectMenuStatic extends Struct<MessageCardEmbedSelectMenuStatic>,MessageCardExtraElement,json.Marshaler,MessageCardActionElement,json.Token{
	...
	export interface MessageCardImage extends MessageCardElement,json.Marshaler,json.Token,Struct<MessageCardImage>{
	...
	export interface MessageCardImageModel extends Alias<string>{
	...
	export interface MessageCardLarkMd extends json.Marshaler,Struct<MessageCardLarkMd>,MessageCardText,json.Token,MessageCardExtraElement,MessageCardNoteElement{
	...
	export interface MessageCardMarkdown extends MessageCardElement,json.Marshaler,Struct<MessageCardMarkdown>,json.Token{
	...
	export interface MessageCardNote extends json.Marshaler,MessageCardElement,json.Token,Struct<MessageCardNote>{
	...
	export interface MessageCardPlainText extends json.Token,MessageCardExtraElement,MessageCardNoteElement,json.Marshaler,Struct<MessageCardPlainText>,MessageCardText{
