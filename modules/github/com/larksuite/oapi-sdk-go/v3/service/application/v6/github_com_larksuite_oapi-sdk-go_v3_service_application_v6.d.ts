...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/application/v6'{
	...
	export interface P1AppStatusChangedV6 extends larkevent.EventHandlerModel,Struct<P1AppStatusChangedV6>{
	...
	export interface P1AppUninstalledV6 extends Struct<P1AppUninstalledV6>,larkevent.EventHandlerModel{
	...
	export interface P1OrderPaidV6 extends larkevent.EventHandlerModel,Struct<P1OrderPaidV6>{
	...
	export interface P2ApplicationFeedbackUpdatedV6Handler extends larkevent.EventHandler,Struct<P2ApplicationFeedbackUpdatedV6Handler>{
