...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/approval/v4'{
	...
	export interface MyAiSearchDefinitionScenarioContext extends Struct<MyAiSearchDefinitionScenarioContext>{

			toolRawInstruction:Ref<string>
	}
	export interface MyAiSearchDefinitionScenarioContextBuilder extends Struct<MyAiSearchDefinitionScenarioContextBuilder>{

			toolRawInstruction(toolRawInstruction:string):Ref<MyAiSearchDefinitionScenarioContextBuilder>
			build():Ref<MyAiSearchDefinitionScenarioContext>
	}
	...
	export function newMyAiSearchDefinitionScenarioContextBuilder():Ref<MyAiSearchDefinitionScenarioContextBuilder>
	...
	export interface P1OutApprovalV4Handler extends larkevent.EventHandler,Struct<P1OutApprovalV4Handler>{
	...
	export interface P2ApprovalUpdatedV4Handler extends larkevent.EventHandler,Struct<P2ApprovalUpdatedV4Handler>{
	...
	export function emptyMyAiSearchDefinitionScenarioContext():MyAiSearchDefinitionScenarioContext
	export function emptyRefMyAiSearchDefinitionScenarioContext():Ref<MyAiSearchDefinitionScenarioContext>
	export function refOfMyAiSearchDefinitionScenarioContext(x:MyAiSearchDefinitionScenarioContext,v:Ref<MyAiSearchDefinitionScenarioContext>)
	export function unRefMyAiSearchDefinitionScenarioContext(v:Ref<MyAiSearchDefinitionScenarioContext>):MyAiSearchDefinitionScenarioContext
