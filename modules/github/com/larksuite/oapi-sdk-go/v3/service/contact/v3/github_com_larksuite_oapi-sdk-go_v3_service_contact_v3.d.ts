...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/contact/v3'{
	...
	// @ts-ignore
	import type {error,bool,int,Alias,Nothing,Struct,Ref} from 'go'
	...
	export interface P1ContactScopeChangedV3Handler extends larkevent.EventHandler,Struct<P1ContactScopeChangedV3Handler>{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface P1DepartmentChangedV3 extends larkevent.EventHandlerModel,Struct<P1DepartmentChangedV3>{
	...
	export interface P1UserStatusChangedV3Handler extends larkevent.EventHandler,Struct<P1UserStatusChangedV3Handler>{
	...
	export interface P2CustomAttrEventUpdatedV3Handler extends larkevent.EventHandler,Struct<P2CustomAttrEventUpdatedV3Handler>{
	...
	export interface P2DepartmentDeletedV3 extends Struct<P2DepartmentDeletedV3>,larkevent.EventHandlerModel{
	...
	export interface P2DepartmentUpdatedV3Handler extends Struct<P2DepartmentUpdatedV3Handler>,larkevent.EventHandler{
	...
	export interface P2EmployeeTypeEnumUpdatedV3Handler extends larkevent.EventHandler,Struct<P2EmployeeTypeEnumUpdatedV3Handler>{
	...
	export interface P2ScopeUpdatedV3Handler extends Struct<P2ScopeUpdatedV3Handler>,larkevent.EventHandler{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface P2UserCreatedV3 extends Struct<P2UserCreatedV3>,larkevent.EventHandlerModel{
	...
	export interface P2UserDeletedV3Handler extends larkevent.EventHandler,Struct<P2UserDeletedV3Handler>{
