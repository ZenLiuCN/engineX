...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/corehr/v1'{
	...
	// @ts-ignore
	import type {float64,Struct,Ref,error,bool,int,Alias,Nothing} from 'go'
	...
	export interface P2ContractDeletedV1 extends larkevent.EventHandlerModel,Struct<P2ContractDeletedV1>{
	...
	export interface P2ContractUpdatedV1 extends larkevent.EventHandlerModel,Struct<P2ContractUpdatedV1>{
	...
	export interface P2EmploymentDeletedV1 extends larkevent.EventHandlerModel,Struct<P2EmploymentDeletedV1>{
	...
	export interface P2EmploymentUpdatedV1 extends larkevent.EventHandlerModel,Struct<P2EmploymentUpdatedV1>{
	...
	export interface P2OffboardingUpdatedV1 extends Struct<P2OffboardingUpdatedV1>,larkevent.EventHandlerModel{
	...
	export interface P2OffboardingUpdatedV1Handler extends larkevent.EventHandler,Struct<P2OffboardingUpdatedV1Handler>{
	...
	export interface P2PersonCreatedV1Handler extends larkevent.EventHandler,Struct<P2PersonCreatedV1Handler>{
