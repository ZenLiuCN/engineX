...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/corehr/v2'{
	...
	// @ts-ignore
	import type {float64,error,Alias,Nothing,Ref,int,Struct,bool} from 'go'
	...
	export interface P2OffboardingChecklistUpdatedV2Handler extends Struct<P2OffboardingChecklistUpdatedV2Handler>,larkevent.EventHandler{
	...
	export interface P2OffboardingStatusUpdatedV2Handler extends larkevent.EventHandler,Struct<P2OffboardingStatusUpdatedV2Handler>{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface P2OffboardingUpdatedV2 extends larkevent.EventHandlerModel,Struct<P2OffboardingUpdatedV2>{
	...
	export interface P2ProcessCcUpdatedV2 extends larkevent.EventHandlerModel,Struct<P2ProcessCcUpdatedV2>{
	...
	export interface P2ProcessUpdatedV2Handler extends larkevent.EventHandler,Struct<P2ProcessUpdatedV2Handler>{
