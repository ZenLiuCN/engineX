...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/drive/v1'{
	...
	// @ts-ignore
	import type {error,int,Alias,Nothing,Ref,Struct,bool} from 'go'
	...
	export interface P2FilePermissionMemberRemovedV1Handler extends larkevent.EventHandler,Struct<P2FilePermissionMemberRemovedV1Handler>{
	...
	export interface P2FileTrashedV1 extends larkevent.EventHandlerModel,Struct<P2FileTrashedV1>{
