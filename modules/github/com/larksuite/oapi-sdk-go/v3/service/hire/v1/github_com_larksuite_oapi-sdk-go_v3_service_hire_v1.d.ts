...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/hire/v1'{
	...
	// @ts-ignore
	import type {error,bool,float64,Alias,Nothing,Ref,Struct,int} from 'go'
	...
	export interface P2EcoBackgroundCheckCreatedV1Handler extends larkevent.EventHandler,Struct<P2EcoBackgroundCheckCreatedV1Handler>{
	...
	export interface P2EhrImportTaskForInternshipOfferImportedV1Handler extends larkevent.EventHandler,Struct<P2EhrImportTaskForInternshipOfferImportedV1Handler>{
	...
	export interface P2EhrImportTaskImportedV1Handler extends larkevent.EventHandler,Struct<P2EhrImportTaskImportedV1Handler>{
	...
	export interface P2TalentDeletedV1 extends Struct<P2TalentDeletedV1>,larkevent.EventHandlerModel{
