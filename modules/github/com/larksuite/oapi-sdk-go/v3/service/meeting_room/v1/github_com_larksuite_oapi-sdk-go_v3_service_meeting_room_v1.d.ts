...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/meeting_room/v1'{
	...
	// @ts-ignore
	import type {Struct,int,error,Ref} from 'go'
	...
	export interface P2MeetingRoomCreatedV1 extends Struct<P2MeetingRoomCreatedV1>,larkevent.EventHandlerModel{
	...
	export interface P2MeetingRoomCreatedV1Handler extends Struct<P2MeetingRoomCreatedV1Handler>,larkevent.EventHandler{
	...
	export interface P2MeetingRoomStatusChangedV1Handler extends larkevent.EventHandler,Struct<P2MeetingRoomStatusChangedV1Handler>{
