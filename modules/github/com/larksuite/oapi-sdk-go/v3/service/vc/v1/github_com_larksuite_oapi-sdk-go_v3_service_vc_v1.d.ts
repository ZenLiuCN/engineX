...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/vc/v1'{
	...
	// @ts-ignore
	import type {bool,float64,int,Ref,Struct,error} from 'go'
	//0
	...
	export interface MeetingBuilder extends Struct<MeetingBuilder>{
			...
			meetingConnect(meetingConnect:bool):Ref<MeetingBuilder>
	...
	export interface P2MeetingAllMeetingEndedV1 extends Struct<P2MeetingAllMeetingEndedV1>,larkevent.EventHandlerModel{
	...
	export interface P2MeetingShareStartedV1 extends Struct<P2MeetingShareStartedV1>,larkevent.EventHandlerModel{
	...
	export interface P2ReserveConfigUpdatedV1Handler extends larkevent.EventHandler,Struct<P2ReserveConfigUpdatedV1Handler>{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface P2RoomCreatedV1 extends larkevent.EventHandlerModel,Struct<P2RoomCreatedV1>{
	...
	export interface P2RoomUpdatedV1Handler extends Struct<P2RoomUpdatedV1Handler>,larkevent.EventHandler{
	...
	export interface ReserveMeetingSettingBuilder extends Struct<ReserveMeetingSettingBuilder>{
			...
			meetingConnect(meetingConnect:bool):Ref<ReserveMeetingSettingBuilder>
