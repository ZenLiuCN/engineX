...
declare module 'github.com/larksuite/oapi-sdk-go/v3/ws'{
	...
	// @ts-ignore
	import type {int,Struct,Alias,bool,map,error,GoError,Ref,uint64,int32} from 'go'
	//514
	...
	export interface FrameType extends Alias<int>{
	...
	export interface MessageType extends Alias<string>{
